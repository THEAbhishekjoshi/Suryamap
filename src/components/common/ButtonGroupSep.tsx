  ...
  return (
    <ButtonGroup>
      <Button
        variant={vaBtn1}
        size="lg"
        className={`min-w-[15vw] h-12 ${vaBtn1 == 'default' ? 'bg-[#f6b26b] text-black hover:bg-[#f6b36bab]' : 'bg-[#039dbf] hover:bg-[#039dbfbb]'}`}
        onClick={() => {
          setVaBtn1("default")
          setVaBtn2("ghost")
          setDynamicView(true)
      ...
      <Button
        variant={vaBtn2}
        size="lg"
        className={`min-w-[15vw] h-12 ${vaBtn2 == 'default' ? 'bg-[#f6b26b] text-black hover:bg-[#f6b36bab]' : 'bg-[#039dbf]  hover:bg-[#039dbfbb]'}`}
        onClick={() => {
          setVaBtn1("ghost")
          setVaBtn2("default")
