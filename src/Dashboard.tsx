...
import { House, Zap, CalendarDays } from 'lucide-react';
...
export default function Dashboard() {
    ...
    const [selectedStateInfo, setSelectedStateInfo] = useState<Record<string, string>>({});

    return (
        <div className='grid grid-cols-3 gap-80 map-bg'>
            <SolarPowerGenerationProvider>
                <YearProvider>
                    ...
                    {/* Main Panel */}
                    <div className="flex items-center justify-center  h-screen flex-col font-poppins">
                        {dynamicView ? (
                            <>
                                <DynamicMapChart setTooltipContent={setContent} setSelectedStateInfo={setSelectedStateInfo} />
                                <ReactTooltip
                                    id="map-tooltip"
                                    place="top"
                    ...
                    <div className=' flex justify-center font-poppins'>
                        <div className='flex flex-col flex-col-3 w-[18rem] items-center gap-5 relative z-10'>
                            {/* YearWise Toggle */}
                            <div className='bg-[#039dbf] w-68 mt-3 text-white text-[1rem] rounded-sm flex items-center justify-center  h-12 gap-2'>
                                <div className=' flex gap-1 items-center'>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="size-6 text-yellow-300">
